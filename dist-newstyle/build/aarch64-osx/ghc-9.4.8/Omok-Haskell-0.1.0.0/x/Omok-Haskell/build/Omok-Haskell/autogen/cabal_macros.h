...
/* package Omok-Haskell-0.1.0.0 */
#ifndef VERSION_Omok_Haskell
#define VERSION_Omok_Haskell "0.1.0.0"
#endif /* VERSION_Omok_Haskell */
#ifndef MIN_VERSION_Omok_Haskell
#define MIN_VERSION_Omok_Haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Omok_Haskell */
...
#define CURRENT_COMPONENT_ID "Omok-Haskell-0.1.0.0-inplace-Omok-Haskell"
